# Generated by Django 5.1.7 on 2025-05-05 03:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('registro', 'Registro'), ('actualizacion', 'Actualización'), ('eliminacion', 'Eliminación'), ('ajuste', 'Ajuste manual')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inventarios', to='microEmpresa.producto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('manager', 'Gerente'), ('store', 'Bodega'), ('sales', 'Ventas')], max_length=10)),
